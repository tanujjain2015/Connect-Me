...
export function idbPromise(storeName, method, object) {
  return new Promise((resolve, reject) => {
    //open connection to the database `connect-me` with the version of 1
    const request = window.indexedDB.open('connect-me', 1);
    ...
    request.onupgradeneeded = function(e) {
      ...
      db.createObjectStore('offerings', {keyPath: '_id'});
